...
const CampusPulse = () => {
    ...
    const loadImages = async () => {
      try {
        const categoryImports = {
          'first': import.meta.glob('../assets/images/campus-pulse/first/*.{jpeg,jpg,png,svg}'),
          'second': import.meta.glob('../assets/images/campus-pulse/second/*.{jpeg,jpg,png,svg}'),
          'third': import.meta.glob('../assets/images/campus-pulse/third/*.{jpeg,jpg,png,svg}'),
          'fourth': import.meta.glob('../assets/images/campus-pulse/fourth/*.{jpeg,jpg,png,svg}'),
        };
  ...
  const tabs = [
    ...
    { id: 'first', icon: <FaUserGraduate />, label: 'college' },
    { id: 'second', icon: <FaFutbol />, label: 'Shostel' },
    { id: 'third', icon: <FaMusic />, label: 'studyEng' },
    { id: 'fourth', icon: <FaMusic />, label: 'training' },
  ];
