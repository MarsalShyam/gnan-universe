...
// removies FiDownload
import { FiInstagram, FiFacebook, FiLinkedin, FiTwitter, FiYoutube, FiMail, FiDownload } from 'react-icons/fi';
...
const HeroSection2 = () => {
  ...
  useEffect(() => {
    const handleResize = () => {
      setOverlayOpacity(window.innerWidth < 768 ? 0.4 : 0.3);
    };
  ...
  return (
    <section 
      className="relative min-h-screen flex flex-col items-center text-white pt-20 pb-8"
      style={{ 
        backgroundImage: `linear-gradient(rgba(173, 216, 230, ${overlayOpacity}), rgba(173, 216, 230, ${overlayOpacity})), url(${slider1})`,
